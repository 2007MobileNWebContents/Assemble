 ...
 */
@WebServlet("/other/headset")
public class OtherHeadSetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!list.isEmpty()) {
			...
			RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/other/Other_headset.jsp");
