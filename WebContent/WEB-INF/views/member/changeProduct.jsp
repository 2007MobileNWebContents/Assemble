...
<link rel="stylesheet" type="text/css" href="/css/member/changeProduct.css">
<link rel="stylesheet"
	...
	<section>
		...
		<div id="section_contents">
			...
			<div class="container" id="section_contents_write">
				...
				<form action="/member/changeSend" method="post">
			    ...
			    text-align: center; width :700px;  box-shadow: 5px 5px 10px rgba(0,0,0,0.5);border-radius:5px; ">
					<input type="hidden" name="orderNo" value="${cOrder.orderNo }">
					<input type="hidden" name="pAccount" value="${cOrder.pAccount }">
					...
					<div class="card" style="width: 100%;">
						...
						<!-- 	<img src="/img/9790980_1.jpg" class="rounded float-left"
								style="width: 11%; float: left;">
							<h6 class="card-title" style="font-weight: bold;">이엠텍 지포스
								GTX 1660 SUPER STORM X Dual OC D6 6GB</h6>
					...
					<br> <br>
					<div class="card" style="width: 100%; padding:20px 24px 20px 24px;">
					<h6 style="font-weight: bold;text-align:left; font-size:18px;">교환사유</h6>
					
						<select name="changeRE">
							<option value="mdelivery">판매자의 오배송으로 인한 교환신청</option>
					...
					<div class="card" style="width: 100%;">
						<div class="card" style="width: 100%;">
							<div class="card-body" style="width: 100%;">
                                ...
                                <h6 style="text-align: left; font-size:18px; font-weight: bolder;">상품 배송, 회수지</h6>
								<h6 class="card-title" style="font-weight: bold; text-align: left;">${member.memberName}</h6>
								<p class="card-text" style="text-align: left; margin-bottom: -5px; font-size:15px;">${cOrder.deliveryAddress}</p>
								<p class="card-text"  style="text-align: left;font-size:13px; color: dimgray;">${member.phone}</p>
