...
<body>
               ...
               <div id="login">
                  <div class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
                        ...
                        class="fas fa-lg fa-user-astronaut" style='color: #3d3d3d; margin-top: 5px;'></i>
                     </a>
    ...
    <section>
        <div id="main_image" style="text-align:center;background-color:#FDFDFD;">
        	<img src="/img/other_main.gif" style="height:100%;width:60%;">
        </div>
        <div id="section_title2">
        
        <!--  ----------------------------------------------------------------------------------------------------------------------------------------------------------- -->
            <p>Other</p>
            <p><a href="/other/allList">전체</a> | <a href="/other/monitor">모니터</a> | <a href="/other/keyboard">키보드</a> | <a href="/other/mouse">마우스</a> | <a href="/other/speaker">스피커</a> | <a href="/other/headset" style="font-weight: bold;">헤드셋</a></p>
            <div id="wrap2">
	                ...
	                <a href="/other/content?pCode=${other.pCode } " style="color:black;">
	                    <div class="card" style="width: 20.6rem;">
	                      ...
	                      <div class="card-body" id="card-body">
	                        <h5 class="card-title" id="card-title" style="display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${other.pName }</h5>
	                        <p class="card-text"><fmt:formatNumber value="${other.pPrice }" pattern="###,###,###원"/></p>
	                      </div>
	                    </div>
	                </a>
	            </div>
