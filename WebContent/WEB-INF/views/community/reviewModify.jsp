...
<title>중고거래 게시물 수정</title>
	...
	<link rel="stylesheet" type="text/css" href="/css/community/reviewWrite.css">
            ...
            <div id="section_contents_empty"></div>
                <div class="container" id="section_contents_write">
                    ...
                    <form action="/review/modify" method="post" enctype="multipart/form-data">
                      ...
                      <input type="text" name="reviewNo" value="${review.reviewNo }">
                      <button type="submit" class="btn btn-default" style="margin-left: 83%;">Submit</button>
                      <button type="reset" class="btn btn-default">Cancel</button>
                    </form>
                    <%-- <form action="/review/modify" method="post" enctype="multipart/form-data">
						<input type="text" size="100" name="title" value="${ review.rTitle }"><br><br>
						<textarea rows="30" cols="100" name="contents">${ review.rContents }</textarea><br><br>
