...
<link rel="stylesheet" type="text/css" href="/css/community/CommunityMain.css">
<link rel="stylesheet"
...
<body>
	...
	<section>
		...
		<div id="section_title2">
			...
			<p>
				<a href="/qna/main" style="font-weight: bold;">QnA</a> | <a href="/review/main">후기</a>
			</p>
			<div id="wrap2">
			...
			<tbody>
				<c:forEach var="qnaList" items="${qnaList }">
					<tr>
						...
						<td><a href="/qna/detail?qnaNo=${qnaList.qnaNo }" style="color: black;">${qnaList.qnaTitle }</a></td>
