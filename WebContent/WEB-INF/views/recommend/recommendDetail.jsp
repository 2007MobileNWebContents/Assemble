...
<link rel="stylesheet" type="text/css" href="/css/recommend/recomDetail.css">
		...
		<div class="section_main">
			...
			<div id="basket">
				<img src="/img/cart.PNG" alt="장바구니"
					...
					href="/basket/insert?pCode=${pCode }"><b
					style="font-size: 50px;">장바구니</b></a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<img src="/img/pay.PNG" alt="결제하기"
					style="width: 80px; padding-bottom: 37px;"> &nbsp;&nbsp; <a
					href="/member/pay?pCode=${pCode }"><b style="font-size: 50px; color: red;">결제하기</b></a>
			</div>
			<div id="info">
				<a href="#info">상품정보</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="review">
				...
				<div class="accordion" id="accordionExample">
					...
					<div id="section_contents_bottom"
						style="margin-left: 713px; margin-top: 14px;">
						${reviewpageNavi }
					</div>
				</div> 
				<!-- 수정 끝나는곳 -->
			...
			<div id="section_space" style="text-align: center;">
			<!-- <hr style="width: 87.5%;height: 2px; background-color:gray; border-top: 1px;opacity: 0.4;"> -->
			교환 / 환불</div>
