...
<title>중고거래 게시글</title>
	...
	<link rel="stylesheet" type="text/css" href="/css/deal/dealContents.css">
    ...
    <section>
        ...
        <div id="section_title">
        		...
        		<c:if test="${contents.memberId eq sessionScope.member.memberId }">
                	<input type="image" src="/img/KakaoTalk_20201106_164019478.gif" style="width:10%;height:100%;margin-top:1%;margin-left:90%;" onclick="window.open('/deal/chatToBuyer', '구매자와 채팅중', 'width=400px, height=600px, location=no')">
                </c:if>
                
                <!-- 게시물 아이디와 로그인 중인 아이디가 다를때 판매자와의 채팅이 열림 -->
                <c:if test="${contents.memberId ne sessionScope.member.memberId }">
                	<input type="image" src="/img/KakaoTalk_20201106_164019478.gif" style="width:10%;height:100%;margin-top:1%;margin-left:90%;" onclick="window.open('/deal/chatToWriter', '판매자와 채팅중', 'width=400px, height=600px, location=no')">
                </c:if>
