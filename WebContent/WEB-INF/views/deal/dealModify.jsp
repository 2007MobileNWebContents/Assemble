...
<title>중고거래 게시물 수정</title>
	...
	<link rel="stylesheet" type="text/css" href="/css/deal/dealModify.css">
                ...
                <div class="container" id="section_contents_write">
                    ...
                    <input type="hidden" value="${deal.dealNo }" name="dealNo">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="1" id="comment" placeholder="판매금액을 입력해주세요." name="price"></textarea>
                      </div>
                      <button type="submit" class="btn btn-default" style="margin-left: 83%;" onclick="return question();">Submit</button>
